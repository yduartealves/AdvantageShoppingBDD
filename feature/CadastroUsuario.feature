...
Funcionalidade: Cadastro de usuario
  ...
  Cenario: Cadastro com sucesso
    E informo os dados para cadastro
      ...
      | BRUN330  | felipe.almeidaa14@gmail.com | Felipe2 | Felipe2      | Felipe       | Silva      | (11)94444223 | Brazil | Taboão da Serra | Rua Bueno, 188 | São Paulo | 06784-200 |
    Entao o meu usuario aparece conectado como "BRUN330"
